...
<!-- Left side column. contains the logo and sidebar -->
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					Admin Page <small>Product Detail</small>
				</h1>
				<ol class="breadcrumb">
						...
						<div class="box box-primary">
							...
							<div class="box-body">
								<div class="form-group">
									...
									<span class="form-control" style="width:40%; margin-right:10px; display:inline-block;">${vo.cg_parent}</span>
									<span class="form-control" style="width:40%;  display:inline-block;">${vo.cg_code}</span>
									
								</div>
								<div class="form-group">
									<label for="exampleInputEmail1">Product Name</label> 
									<span class="form-control">${vo.prd_name}</span>
								</div>
								<div class="form-group">
									<label for="exampleInputEmail1">Company</label> 
									<span class="form-control">${vo.prd_company}</span>
								</div>
								<div class="form-group">
									...
									<span class="form-control" style="width:40%; display:inline-block;">${vo.prd_discount}</span>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<span class="form-control" style="width:40%; margin-right:10px; display:inline-block;">${vo.prd_stock}</span>
									<span class="form-control" style="width:40%; display:inline-block;">${vo.prd_buy}</span>
								</div>
								<div class="form-group">
									...
									<span class="form-control" style="width:40%; margin-right:10px; display:inline-block;">
										<fmt:formatDate value="${vo.prd_date_post}" pattern="yyyy-MM-dd HH:mm:ss"/></span>
									<span class="form-control" style="width:40%; display: inline-block;">
										<fmt:formatDate value="${vo.prd_date_up}" pattern="yyyy-MM-dd HH:mm:ss"/></span>
